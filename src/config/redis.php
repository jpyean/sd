 ...
 * 本地环境
 */
$config['redis']['online']['ip'] = '127.0.0.1';
$config['redis']['online']['port'] = 6379;
$config['redis']['online']['select'] = 1;
$config['redis']['online']['password'] = '123456';
